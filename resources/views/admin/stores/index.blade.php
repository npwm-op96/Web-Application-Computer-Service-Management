        ...
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label class="control-label col-md-4" >ชื่อเครื่อง : </label>
            <div class="col-md-8">
            ...
            <div class="form-group">
            <label class="control-label col-md-4" >ยีห้อ : </label>
            <div class="col-md-8">
             <input type="text" name="brand" id="brand" class="form-control" />
            </div>
           </div>
            <div class="form-group">
            <label class="control-label col-md-4" >รุ่น : </label>
            <div class="col-md-8">
             <input type="text" name="model" id="model" class="form-control" />
            </div>
           </div>
            <div class="form-group">
            <label class="control-label col-md-4" >รหัสบริการ : </label>
            <div class="col-md-8">
             <input type="text" name="servicetag" id="servicetag" class="form-control" />
            </div>
           </div>
...
<div id="confirmModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 align="center" style="margin:0;">คุณแน่ใจที่จะลบ สมาชิกท่านนี้ออกจาดระบบ ?</h6>
            </div>
...
$(document).ready(function(){
 ...
 $('#create_record').click(function(){
  $('.modal-title').text("เพิ่มคอมพิวเตอร");
     $('#action_button').val("เพิ่มอุปกรณ์");
     $('#action').val("Add");
