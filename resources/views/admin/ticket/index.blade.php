		...
		<div class="row">
		    ...
		    <div class="col-lg-12 margin-tb">
		        ...
		        <div class="pull-right">
						...
						<button type="button" class="btn btn-success btn-circle btn-xl" data-toggle="modal" data-target="#create-item"><a  class="fas fa-plus"></a></button>
						        <a href="{{url('ticket')}}"  class="btn btn-secondary btn-circle btn-xl"><span class="fas fa-undo-alt"></span> </a></button>
								<a href="{{url('ticket')}}"  class="btn btn-info btn-circle btn-xl"><span class="fas fa-file-export"></span> </a></button>
