        ...
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label class="control-label col-md-4" >หมายเลข : </label>
            <div class="col-md-8">
             <input type="text" name="numbers" id="numbers" class="form-control" />
            </div>
           </div>
           <div class="form-group">
            <label class="control-label col-md-4" >ผู้ใช้ : </label>
            <div class="col-md-8">
             <input type="text" name="id_emp" id="id_emp" class="form-control" />
            </div>
           </div>
            <div class="form-group">
            <label class="control-label col-md-4" >กรุ๊ป : </label>
            <div class="col-md-8">
             <input type="text" name="num_group" id="num_group" class="form-control" />
            </div>
           </div>
...
$(document).ready(function(){
 ...
 $('#create_record').click(function(){
  $('.modal-title').text("เพิ่มหมายเลขโทรศัพภายใน");
     $('#action_button').val("เพิ่มหมายเลข");
     $('#action').val("Add");
